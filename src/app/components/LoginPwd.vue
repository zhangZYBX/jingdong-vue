<template>
	<div class="login-pwd">
		<div class='form-item-wrapper'>
			<input type="text" class="pwd-phone" placeholder='用户名/邮箱/已验证手机' v-model="loginInfo.name">
		</div>
		<div class='form-item-wrapper'>
			<input type="password" class="pwd-word" placeholder='请输入密码' v-model="loginInfo.pwd">
			<i></i>
			<span>忘记密码</span>
		</div>
		...
		methods: {
			login() {
				this.$http({
					...
					this.$router.replace(Cookies.get('target') ||'/category');
				})
			}
		}
	}
